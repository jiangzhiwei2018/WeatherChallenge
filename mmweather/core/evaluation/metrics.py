...
from mmweather.datasets.pipelines.matlab_like_resize import MATLABLikeResize
...
class L1Evaluation:
    ...
    def __call__(self, data_dict):
        ...
        from mmweather.models.losses.pixelwise_loss import l1_loss
...
def niqe(img, crop_border, input_order='HWC', convert_to='y'):
    ...
    # we use the official params estimated from the pristine dataset.
    niqe_pris_params = np.load('mmweather/core/evaluation/niqe_pris_params.npz')
