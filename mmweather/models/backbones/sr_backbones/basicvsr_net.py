...
class ResidualBlocksWithInputConv(nn.Module):
    ...
    def __init__(self, in_channels, out_channels=64, num_blocks=30, act_cfg=None):
        super().__init__()
        if act_cfg is None:
            act_cfg = dict(
                type="ReLU",
        ...
        main.append(build_activation_layer(act_cfg))

        # residual blocks
        main.append(
            make_layer(
                ResidualBlockNoBN, num_blocks, mid_channels=out_channels, act_cfg=act_cfg))
